...
# If you haven't installed already, use the instructions above, i.e.:
# source("http://bioconductor.org/biocLite.R")
# biocLite("Biobase")
# biocLite("GEOquery")
# ...etc.
...
Before we do any analysis, let's do some quality control using the [arrayQualityMetrics](http://www.bioconductor.org/packages/release/bioc/html/arrayQualityMetrics.html) Bioconductor package. Note that this can take some time.
